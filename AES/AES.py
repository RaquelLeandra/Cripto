...
def changingBytesub():
    ...
    if cont != 250:
        print('No dan lo mismo, hay ', cont, ' iguales y deberian ser 250')
...
def littleChanges1():
    """
    This functions prints an histogram of the positions changes of the encrypted
     message if we change one bit of the key.
    :return:
    """
...
def littleChanges2():
    """
    This functions prints an histogram of the positions changes of a message if we change one bit of the key.
    :return:
    """
